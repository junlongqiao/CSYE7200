...
object Function {
  ...
  def map7[T1, T2, T3, T4, T5, T6, T7, R](t1y: Try[T1], t2y: Try[T2], t3y: Try[T3], t4y: Try[T4], t5y: Try[T5], t6y: Try[T6], t7y: Try[T7])
                                         (f: (T1, T2, T3, T4, T5, T6, T7) => R): Try[R] = for(t1<-t1y;t2<-t2y;t3<-t3y;t4<-t4y;t5<-t5y;t6<-t6y;t7<-t7y) yield f(t1,t2,t3,t4,t5,t6,t7) // TO BE IMPLEMENTED
  ...
  (Try[T1], Try[T2], Try[T3], Try[T4], Try[T5], Try[T6], Try[T7]) => Try[R] = for(t1: T1 <- _;t2: T2 <- _;t3: T3 <- _;t4: T4 <- _;t5: T5 <- _;t6: T6 <- _;t7: T7 <- _) yield f(t1,t2,t3,t4,t5,t6,t7) // TO BE IMPLEMENTED
  ...
  def uncurried2[T1, T2, T3, R](f: T1 => T2 => T3 => R): (T1, T2) => T3 => R = (t1: T1, t2: T2) => f(t1)(t2) // TO BE IMPLEMENTED
  ...
  def uncurried3[T1, T2, T3, T4, R](f: T1 => T2 => T3 => T4 => R): (T1, T2, T3) => T4 => R = (t1: T1, t2: T2, t3: T3) => f(t1)(t2)(t3) // TO BE IMPLEMENTED
  ...
  def uncurried7[T1, T2, T3, T4, T5, T6, T7, T8, R](f: T1 => T2 => T3 => T4 => T5 => T6 => T7 => T8 => R): (T1, T2, T3, T4, T5, T6, T7) => T8 => R =
    (t1: T1, t2: T2, t3: T3, t4: T4, t5: T5, t6: T6, t7: T7) => f(t1)(t2)(t3)(t4)(t5)(t6)(t7) // TO BE IMPLEMENTED
